...
class MessageQueueBase(object):
    ...
    def start_consuming(self, exchange_durable=False):
        ...
        if self.__queue_name:
            ...
            result = channel.queue_declare(queue=self.__queue_name, exclusive=True)
    ...
    def create_channel(self):
        ...
        self.__connection = pika.BlockingConnection(
            pika.ConnectionParameters(self.addr, self.port, self.vhost, credentials=credentials, heartbeat=0))
    ...
    def publish_message(self, body, durable=True, exchange_durable=False):
        ...
        if self.__queue_name:
            ...
            result = self.__channel.queue_declare(queue=self.__queue_name, exclusive=True)
